...
public class RatingService {
    ...
    public String getDifficultyInstructions(int userRating) {
        String baseInstruction = "Keep one thing while generating the questions: higher the rating, harder the questions should be. ";

        if (userRating < 800) {
            return baseInstruction + "DIFFICULTY: BEGINNER. Focus on core fundamentals, definitions, and basic syntax. " +
            ...
            return baseInstruction + "DIFFICULTY: INTERMEDIATE. Focus on practical application and framework features. " +
            ...
            return baseInstruction + "DIFFICULTY: ADVANCED. Focus on complex integrations, performance, and optimization. " +
            ...
            return baseInstruction + "DIFFICULTY: EXPERT. Focus on high-scale system design, internal framework workings, and elite architectural patterns. " +
